...
-- moving tab
keymap("n", "<Leader>t>", "<Cmd>+tabmove<CR> | <Cmd>redraw<CR>", "Move the current tab to the right")
keymap("n", "<Leader>t<", "<Cmd>-tabmove<CR> | <Cmd>redraw<CR>", "Move the current tab to the left")
