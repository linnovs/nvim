...
vim.opt.fillchars = { eob = " ", fold = " ", foldopen = "󰅀", foldsep = " ", foldclose = "󰅂" } -- characters to use for displaying special items
vim.opt.foldcolumn = "0" -- columns to use for the fold column
