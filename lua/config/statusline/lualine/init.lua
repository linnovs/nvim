...
local lsp = require("config.statusline.lualine.lsp")
local git = require("config.statusline.lualine.git")
local file = require("config.statusline.lualine.file")
local gps = require("config.statusline.lualine.gps")
